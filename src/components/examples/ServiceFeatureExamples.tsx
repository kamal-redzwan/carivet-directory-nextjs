...
import { Search, Filter, Shield, ChevronRight } from 'lucide-react';
    ...
    <div className='space-y-6'>
      ...
      <Card>
        ...
        <CardContent className='space-y-6'>
          ...
          {/* Services Filter - ENHANCED WITH ARROWS */}
          <div className='space-y-3'>
            ...
            <div className='grid grid-cols-1 gap-2 max-h-32 overflow-y-auto'>
              {filterOptions.services.map((service) => (
                <div
                  key={service}
                  className='flex items-center justify-between space-x-2 p-2 hover:bg-gray-50 rounded-md transition-colors'
                >
          ...
          {/* Specializations Filter - ENHANCED WITH ARROWS */}
          <div className='space-y-3'>
